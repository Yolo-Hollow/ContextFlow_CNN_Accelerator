...
Use the repository [Chinese README](../../README.md#快速启动与复现) or [English README](../../README_EN.md#quick-start-and-reproduction) for JTAG startup, SD-card cold boot, and WebUI inference instructions. Canonical measurements are recorded in the [release manifest](../../docs/contextflow_34p9_release_manifest_EN.md).
