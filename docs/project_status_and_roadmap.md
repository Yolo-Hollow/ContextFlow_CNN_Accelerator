...
- The subperf XSA SHA256 is `ECD4AE2294182AD33C40E2A4C1981940581244F41C210A1903391369121D5A64`; the bitstream SHA256 is `1877EECE3855A6176A7C5C800A1EBA115A21A2E273B9B6E564179600CB779B2A`. Board validation for this `subperf_2022_2` build is intentionally deferred; the next board run should fully reprogram the bitstream, run Conv0->Conv9 batch bit-exact validation, then run the two DDR demos and compare `SUBPERF` residuals against the drainpipe baseline.
