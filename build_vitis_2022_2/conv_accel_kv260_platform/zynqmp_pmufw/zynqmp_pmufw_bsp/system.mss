...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = accel
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = accel_gpio
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.15
 PARAMETER HW_INSTANCE = dma_bias
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.15
 PARAMETER HW_INSTANCE = dma_ifm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.15
 PARAMETER HW_INSTANCE = dma_ofm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.15
 PARAMETER HW_INSTANCE = dma_weight
END
