...
`define TB_CONV_ACCEL_CORE_MODULE tb_conv_accel_core_axi_lite_axis_stream_r18_c16_b2_layer06_ext_full
...
`define TB_CONV_ACCEL_CORE_TILE_OFM_H 52
`define TB_CONV_ACCEL_CORE_TILE_PIXEL_BASE 0
`define TB_CONV_ACCEL_CORE_TILE_COUNT 1
`define TB_CONV_ACCEL_CORE_IFM_D 4096
`define TB_CONV_ACCEL_CORE_IFM_AW 12
`define TB_CONV_ACCEL_CORE_PSUM_D 4096
`define TB_CONV_ACCEL_CORE_PSUM_AW 12
...
`define TB_CONV_ACCEL_CORE_OFM_FIFO_DEPTH 1024
`define TB_CONV_ACCEL_CORE_OFM_FIFO_AW 10
...
`define TB_CONV_ACCEL_CORE_TIMEOUT 120000000
