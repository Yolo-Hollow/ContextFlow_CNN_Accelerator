...
$tests = @(
    ...
    @{ Top = "tb_systolic_top_feeder_ifm_pingpong"; Files = @("tb/tb_systolic_top_feeder_ifm_pingpong.v") },
...
$longTests = @(
    ...
    @{ Top = "tb_conv_accel_core_axi_lite_axis_stream_conv5_3x3_raw_hwc_fulltile_cout16"; Files = @("tb/tb_conv_accel_core_axi_lite_axis_stream_conv5_3x3_raw_hwc_fulltile_cout16.v") },
    @{ Top = "tb_conv_accel_core_axi_lite_axis_stream_conv6_3x3_raw_hwc_fulltile_cout16"; Files = @("tb/tb_conv_accel_core_axi_lite_axis_stream_conv6_3x3_raw_hwc_fulltile_cout16.v") },
    @{ Top = "tb_conv_accel_core_axi_lite_axis_stream_conv8_3x3_raw_hwc_fulltile_cout16"; Files = @("tb/tb_conv_accel_core_axi_lite_axis_stream_conv8_3x3_raw_hwc_fulltile_cout16.v") },
