...
module tb_requant;
    ...
    requant u(.clk(clk),.rst(rst),.mult0(m0),.mult1(m1),.shift0(s0),.shift1(s1),
    ...
    initial begin
        ...
        feed_check(-50, -100);   // negative
        feed_check(  0,    0);   // zero
        feed_check( 50,  100);   // positive
        feed_check(250,  500);   // saturating positive

        $display("=== saturation ===");
        m0=10000; m1=10000; s0=0; s1=0; z0=0; z1=0;
        feed_check( 500000, -500000);  // clamp to 127 / -128
