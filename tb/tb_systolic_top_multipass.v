...
module tb_systolic_top_multipass;
    ...
    systolic_top #(
        ...
        .ifm_pingpong_enable(1'b0), .ifm_wr_bank(1'b0), .ifm_rd_bank(1'b0),
        ...
        .psum_fifo_rd_en(psum_rd_en), .psum_fifo_rd_data(psum_rd_data),
        .psum_fifo_empty(psum_empty), .psum_fifo_wr_en_dbg()
    );
